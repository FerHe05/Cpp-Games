...
Game::Game(): mWindow(sf::VideoMode(WIDTH_SCREEN + WIDTH_RIGHT_PANEL * 2, HEIGHT_SCREEN), "Battle City")
, mFont()
...
{
    mFont.loadFromFile("CourseSFML/resources/Sansation.ttf");  //se estiver na mesma pasta de SFML sln: "Sansation.ttf"
